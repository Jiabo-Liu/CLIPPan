...
class restormer_cablock(nn.Module):
    def __init__(
        ...
        super().__init__()
        self.convA1 = nn.Conv2d(8, restormerdim, kernel_size=3, stride=1, padding=1, bias=bias)
...
class Net(nn.Module):
    def __init__(
        ...
        self.nihe = nn.Conv2d(out_channel,1, kernel_size=1)
    ...
    def forward(self, imageA, imageB, text):
        ...
        nihe = self.nihe(fusionfeature)
        return fusionfeature,nihe
